...
public abstract class BaseRecyclerCursorAdapter0<T extends RecyclerView.ViewHolder>
    ...
    public BaseRecyclerCursorAdapter0(BaseRecyclerFragment recyclerFragment) {
